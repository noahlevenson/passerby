...
const pork_pastor = tacos_section.add_child(new Hntree_node({parent: tacos_section, data: new Hbuy_item({name: "Pork Pastor", desc: "seared pork marinated in guajillo & pineapple sauce, topped with cilantro, onion, pineapple & salsa fresca", sizes: [new Hbuy_item_size({price: 5.00, cust_cats: []})]})}));
const chx_tinga = tacos_section.add_child(new Hntree_node({parent: tacos_section, data: new Hbuy_item({name: "Chicken Tinga", desc: "shredded chicken marinated in a medium-spicy tinga sauce topped with onions & cilantro", sizes: [new Hbuy_item_size({price: 4.00, cust_cats: []})]})}));
const duck_confit = tacos_section.add_child(new Hntree_node({parent: tacos_section, data: new Hbuy_item({name: "Duck Confit", desc: "duck confit, chipotle-hoisin sauce, scallions & shaved jalapeño on a flour tortilla", sizes: [new Hbuy_item_size({price: 5.00, cust_cats: []})]})}));
...
const enchiladas = platos_grandes_section.add_child(new Hntree_node({parent: platos_grandes_section, data: new Hbuy_item({name: "Enchiladas Rojas", desc: "served with cantina rice & beans", sizes: [new Hbuy_item_size({desc: "chicken", price: 19.00, cust_cats: []}), new Hbuy_item_size({desc: "shrimp", price: 19.00, cust_cats: []}), new Hbuy_item_size({desc: "flank steak", price: 20.00, cust_cats: []}), new Hbuy_item_size({desc: "Impossible Meat", price: 20.00, cust_cats: []})]})}));
const chx_mole = platos_grandes_section.add_child(new Hntree_node({parent: platos_grandes_section, data: new Hbuy_item({name: "Chicken Mole", desc: "grilled chicken in a 12-hour mole sauce. served with rice & refried beans", sizes: [new Hbuy_item_size({price: 20.00, cust_cats: []})]})}));
const steak = platos_grandes_section.add_child(new Hntree_node({parent: platos_grandes_section, data: new Hbuy_item({name: "Grilled Skirt Steak Asado", desc: "served with cantina rice & beans", sizes: [new Hbuy_item_size({price: 20.00, cust_cats: []})]})}));
