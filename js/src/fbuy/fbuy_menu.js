/** 
* FBUY_MENU
* Class for an Fbuy menu
* FBUY_MENU objects serialize to 
...
class Fbuy_menu {
	...
	constructor({
		...
		data = null
			...
			this.ffments = ffments === null ? Object.fromEntries(Object.values(Fbuy_ffment.DEFAULT).map((ffment, i) => {
				return [i, ffment];
			})) : Object.fromEntries(Object.entries(ffments).map(ffment => [ffment[0], new Fbuy_ffment(ffment[1])]));
