...
class Futil {
	// JSON serializer for javascript's Map() type -- this is set on the Map prototype at the FAPP layer as above
	...
	// Instead, we implement a Map.from_JSON() function (curently set on the prorotype at the FAPP layer)
